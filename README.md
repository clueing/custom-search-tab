...
项目地址：https://github.com/clueing/custom-search-tab

## 功能特性

- 🌅 **必应每日壁纸** - 自动获取必应每日壁纸作为新标签页背景
  - 📅 支持切换上一天 / 下一天的壁纸，并显示日期
  - 🔒 支持锁定壁纸，锁定后固定显示、不再自动更新
  - ℹ️ 显示壁纸标题与版权详情
- 🔍 **多搜索引擎** - 支持必应、谷歌、百度等多种搜索引擎切换，可添加自定义引擎
- ⌨️ **搜索建议** - 提供实时搜索建议功能（可关闭以提升隐私）
- 🚀 **快捷方式管理** - 可自定义添加、编辑、删除常用网站快捷方式
  - 🖱️ 右键唤出编辑 / 删除操作
  - 🌐 图标支持 Google Favicon 与网站自带 favicon.ico
- 💾 **配置备份** - 一键导出 / 导入全部配置（搜索引擎、快捷方式、布局与偏好）
- ⚙️ **可定制界面** - 可在设置中开关壁纸详情、日期、切换与锁定按钮
- 🎨 **响应式设计** - 适配不同屏幕尺寸
